...
public class DetEvento {
    ...
    @XmlElement(namespace = "http://www.portalfiscal.inf.br/nfe", required = true)
    protected List<DetEvento.GImobilizacao> gImobilizacao;
     ...
     * 
     */
    public List<DetEvento.GImobilizacao> getGImobilizacao() {
        if (gImobilizacao == null) {
            gImobilizacao = new ArrayList<DetEvento.GImobilizacao>();
        }
