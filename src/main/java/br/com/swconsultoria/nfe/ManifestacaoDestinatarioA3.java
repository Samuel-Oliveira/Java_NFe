...
public class ManifestacaoDestinatarioA3 {
    ...
    static TRetEnvEventoManifestacao eventoManifestacao(ConfiguracoesNfe config, boolean valida,  String xmlAssinado) throws NfeException {
        ...
        return XmlNfeUtil.xmlToObject(xmlAssinado, TRetEnvEventoManifestacao.class);
    }

    static String montarXML(ConfiguracoesNfe config, TEnvEventoManifestacao envEvento) throws NfeException {
        try {
