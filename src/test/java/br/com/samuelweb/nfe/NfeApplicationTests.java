...
public class NfeApplicationTests {
    ...
    public void enviarNfe() {
        ...
        try {
            ...
            System.out.println(XmlUtil.objectToXml(enviNFe));
    ...
    public void testarCodigoMunicipio() {
        ...
        retornoValidar = validarMunicipio.validar(9999999, new Object());
        System.out.println(retornoValidar.getValido() ? "valido": "Inválido:"+retornoValidar.getMensagem());

        retornoValidar = validarMunicipio.validar(5203962, new Object());
        System.out.println(retornoValidar.getValido() ? "valido": "Inválido:"+retornoValidar.getMensagem());

        retornoValidar = validarMunicipio.validar(9999999, new Object());
        System.out.println(retornoValidar.getValido() ? "valido": "Inválido:"+retornoValidar.getMensagem());

        retornoValidar = validarMunicipio.validar(320000, new Object());
        System.out.println(retornoValidar.getValido() ? "valido": "Inválido:"+retornoValidar.getMensagem());

        retornoValidar = validarMunicipio.validar(4123456, new Object());
        System.out.println(retornoValidar.getValido() ? "valido": "Inválido:"+retornoValidar.getMensagem());

        retornoValidar = validarMunicipio.validar(5200050, new Object());
        System.out.println(retornoValidar.getValido() ? "valido": "Inválido:"+retornoValidar.getMensagem());

        retornoValidar = validarMunicipio.validar(4118501, new Object());
        System.out.println(retornoValidar.getValido() ? "valido": "Inválido:"+retornoValidar.getMensagem());
    }
