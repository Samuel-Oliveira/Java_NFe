#!/usr/bin/env bash
# =====================================================================
# migrate.sh — Migra imports Java de java-nfe v4.00.* para v4.1.3
#
# USO:
...
#
# A v4.1.* consolidou ~48 sub-packages em 2 packages:
...
echo ""
echo "=== java-nfe v4.00.51 -> v4.1.* Migration Script (bash) ==="
echo ""
if $DRY_RUN; then
